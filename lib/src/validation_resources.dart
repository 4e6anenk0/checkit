...
abstract interface class IValidationPatterns {
...
class ValidationPatterns implements IValidationPatterns {
...
class ValidationResources extends ValidationResourcesBase {
  ...
  // Пример для добавления других ленивых ресурсов:
  // RegExp? _phonePattern;
  // @override
  // RegExp get phonePattern => _phonePattern ??= RegExp(...);
}
